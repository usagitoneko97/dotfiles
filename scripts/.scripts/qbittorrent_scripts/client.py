"""
This code is licensed under the MIT license to v1k45
please refer to https://github.com/v1k45/python-qBittorrent/blob/master/LICENSE
"""
import requests
import json
